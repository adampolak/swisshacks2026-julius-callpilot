...
async function generateReport() {
  ...
  reportEls.status.querySelector("span:last-child").textContent = `Generating report in ${mode} mode...`;
  ...
  try {
    ...
    reportEls.status.querySelector("span:last-child").textContent = result.error
      ? "DeepSeek failed; mock report is shown."
      : `Generated ${pipeline.mode} report.`;
  } finally {
